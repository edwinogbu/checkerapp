...
// import React, { useState } from 'react';
// import { View, StyleSheet, Text, ScrollView, TextInput, SafeAreaView, TouchableOpacity, Alert } from 'react-native';
...
//                 {Array.from(new Set(studentResults.map((result) => result.semester))).map((semesterOption) => (
//                   <Picker.Item
//                     key={semesterOption}
//                     label={semesterOption}
...
//                 {Array.from(new Set(studentResults.map((result) => result.session))).map((sessionOption) => (
//                   <Picker.Item
//                     key={sessionOption}
//                     label={sessionOption}
//                     value={sessionOption}
